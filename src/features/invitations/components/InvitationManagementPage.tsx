import {canManageInvitations as checkCanManageInvitations, type UserRole,} from "@/auth/accessControl";
...
export const InvitationManagementPage = ({currentRole,}: InvitationManagementPageProps) => {
    const invitationList = useInvitationList();
    const canManageInvitations = checkCanManageInvitations(currentRole);
    return (
